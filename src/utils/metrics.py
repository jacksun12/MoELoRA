...
def hit_rate_at_k(predictions, targets, k=10):
    """
    计算 HR@K (Hit Rate)
    predictions: 模型的预测得分或概率分布 (batch_size, num_classes)
    targets: 真实的下一个电影 ID (batch_size,)
    """
...
class SystemProfiler:
    """
    用于精准测量系统延迟和显存占用的上下文管理器。
    对于系统论文，我们需要测量 P99 Latency 和 Peak Memory。
    """
